...
> **Status:** snapshot from the initial framework setup. The suite has since grown — as of Aug 2026 there are 6 test files (`advanced-features`, `compactionEngine`, `normalizeSector`, `recallDurableMemories`, `schema`, `sseValidation`) with 67 test declarations; 63/63 passed as of 2026-08-04 (see `docs/todo.md`). Run `npm test` for the current pass count.
