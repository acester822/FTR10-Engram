...
exports.generateCodexConfig = generateCodexConfig;
exports.writeCodexConfig = writeCodexConfig;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const os = __importStar(require("os"));
function generateCodexConfig(backendUrl, apiKey, useMCP = false, mcpServerPath) {
    if (useMCP) {
...
async function writeCodexConfig(backendUrl, apiKey, useMCP = false, mcpServerPath) {
